...
```
---------------------------------------------------------------------------AttributeError
Traceback (most recent call last)<ipython-input-1-540320485c00> in
<module>
     40 currdat = 'counties'
     41
---> 42 w =
ps.queen_from_shapefile('censuscounties17/censuscounties17.shp')
     43 wtr =
ps.queen_from_shapefile('censustracts17/censustracts17.shp')
     44
