...
tractdatchoice = tractdat[['age80_84', 'age65_69','black_nh','hhldralone']]

#this chunk just clusters without regard to contiguity
#km1 = cluster.KMeans(n_clusters = ndist)
#clustkm1 = km1.fit(tractdatchoice.drop(['geonum'],axis = 1).values)
#
...
f, ax = plt.subplots(1, figsize=(9,9))
tractdat.assign(cl = pregazp.labels_).plot(column = 'cl', categorical = True, legend = True, linewidth = .1, edgecolor = 'white', ax = ax)
ax.set_axis_off()
f.show()
#try this http://darribas.org/gds_scipy16/ipynb_md/07_spatial_clustering.html
